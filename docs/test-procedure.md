...
## Snapshots
<details><summary><h3>Naming convention</h3></summary>
...
<details><summary><h3>Document your findings</h3></summary>
 
Each snapshot Markdown should follow this **structured template**:

```md
# Snapshot: [branch1] vs [branch2]

## [branch1]
- [latest commit hash of branch1]
...
Asset filenames should clearly identify the test target, run number, targeted branch and lastly the specific type of test or measurement.
...
#### General format
```yaml
[baseline branch]-vs-[candidate branch]-run[iteration]-[tested-branch]-[asset-type].[extension]
```

#### Single-branch case
omit the `vs-[candidate branch]` and `[tested-branch]` sections:
```yaml
...
| --------------------- | ----------------------------------- | -------------------------------- |
| Lighthouse screenshot | main-vs-packages-run1-main.png           | main-run1.png                    |
| WebPageTest waterfall | main-vs-packages-run1-main-waterfall.png | main-run1-waterfall.png          |
| JSON export           | main-vs-packages-run1-main.json          | main-run1.json                   |

#### Examples (multi-branch)

```yaml
lighthouse/main-vs-packages-run1-main-screenshot.png
lighthouse/main-vs-packages-run1-packages-lcp.png
webpagetest/main-vs-packages-run1-main-waterfall.png
webpagetest/main-vs-svelte-run1-svelte-fcp.png
```
